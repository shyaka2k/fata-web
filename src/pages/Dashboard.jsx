...
function Dashboard({ userName }) {
  const stats = [
    { label: "Peace Missions Completed", value: "75%" },
    { label: "Cultural Programs", value: "50+" },
    { label: "Youth & Women Empowered", value: "1200+" },
  ];
    ...
    <div className="font-sans bg-gradient-to-b from-white to-blue-50 text-gray-800 min-h-screen">
      ...
      <section className="text-center py-20 bg-gradient-to-r from-blue-300 via-blue-200 to-blue-100">
        ...
        <div className="space-x-4">
          <Link to="/activities">
            <motion.button whileHover={{ scale: 1.05 }} className="px-6 py-3 bg-green-500 text-white rounded-lg shadow-md">
              Explore Activities
            </motion.button>
          </Link>
          <Link to="/events">
            <motion.button whileHover={{ scale: 1.05 }} className="px-6 py-3 bg-blue-500 text-white rounded-lg shadow-md">
              Upcoming Events
            </motion.button>
          </Link>
        </div>
      ...
      {/* Stats */}
      <section className="bg-white shadow-md py-6 px-6 flex justify-around items-center">
        {stats.map((stat, idx) => (
